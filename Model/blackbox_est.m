...
blackbox_id_1dof.Notes = "Dati con filtro a 25rad/s, con filtro spostato a 25Hz";
blackbox_id_1dof.Name = "blackbox id 1dof";

figure
bode( blackbox_id_1dof ); hold on; legend
...
blackbox_id_2dof.Notes = "Dati con filtro a 25rad/s, con filtro spostato a 25Hz";
blackbox_id_2dof.Name = "blackbox id 2dof";

figure
bode( blackbox_id_2dof ); hold on; legend
