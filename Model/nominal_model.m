...
nominal_sys_1dof.Structure.Parameters(12).Minimum = B_1*0.8;
...
nominal_sys_2dof.Structure.Parameters(13).Minimum = K_s2*0.8;
nominal_sys_2dof.Structure.Parameters(13).Maximum = K_s2*1.05;
nominal_sys_2dof.Structure.Parameters(14).Minimum = J_2*0.8;
nominal_sys_2dof.Structure.Parameters(14).Maximum = J_2*1.2;
nominal_sys_2dof.Structure.Parameters(15).Minimum = B_2*0.8;
nominal_sys_2dof.Structure.Parameters(15).Maximum = B_2*1;
