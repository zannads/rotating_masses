...
% A(3,4) = 1;
% A(4,:) = [K_s1/(K_g*J1),0,-2*K_s2/J1,-B1/J1,K_s2/J1,0];
...
% A=zeros(4,4);
% A(1,2) = 1;
% A(2,:) = [-K_s1/(eta_m*eta_g*K_g^2*J_eq),-B_eq/J_eq,K_s1/(eta_m*eta_g*K_g*J_eq),0];
% A(3,4) = 1;
% A(4,:) = [K_s1/(K_g*J1),0,-K_s1/J1,-B1/J1];
% 
% B = [0,1/J_eq,0,0]';
A=zeros(4,4);
A(1,2) = 1;
A(2,:) = [-K_s1/(J_eq),-B_eq/J_eq,K_s1*K_g/J_eq,0];
A(3,4) = 1;
A(4,:) = [K_s1/(K_g*J1),0,-K_s1/J1,-B1/J1];
